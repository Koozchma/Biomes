...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 2. 'targetUrl' for Desert points to 'regions/desert_production.html'.
    //    Other regions point to .png files within 'images/regions/' or null.
    //    Ensure these files exist at these paths in your repository with correct casing.
    const regions = [
        {
            name: 'Desert',
            shape: 'rect',
            coords: [30, 30, 450, 300], // Original coordinates from your first script
            targetUrl: 'regions/desert_production.html', // Points to the new HTML page for desert
